...
class Snake:
    def __init__(self):
        ...
        for x, y in self.coordinates:
            square = canvas.create_rectangle(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=SNAKE_COLOR, tag="snake-string")
...
class Food:
    def __init__(self):
        ...
        y = random.randint(0, (GAME_HEIGHT / SPACE_SIZE) - 10) * SPACE_SIZE
...
# Creating the objects from Class
...
score_label = Label(window, text="Score:{}".format(score), font=("", 25))
score_label.pack()
button = Button(window, text="Start New Game", command=new_game)
button.pack()
